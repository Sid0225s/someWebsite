  ...
  return (
    <div>
      <nav className=" bg-blue-950 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div className=" text-white first-letter:max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0   md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <NavLink
                  to="/"
              ...
              <li>
                <button
                  ...
                  class="flex items-center justify-between w-full py-2 pl-3 pr-4 text-white rounded hover:bg-blue-500 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500 dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
                >
                  About{" "}
                  <svg
